...
#             agent_name="Requirement Deduplication Agent",
#             source_module=(
#                 "app.agents.Deduplication_Agent.Agent"
#             ),
#         )
...
#             self._graph = build_deduplication_graph(
#                 llm=self.llm,
#             )
...
#     ) -> dict[str, Any]:
#         """
#         Run requirement deduplication.

#         Important token behaviour:
#         - bearer_token is copied into the LangGraph state.
#         - the graph uses it only for LLM token-usage logging.
#         - it is not passed to enterprise/agent logging.
#         """
...
#             message=(
#                 "Requirement deduplication processing started"
#             ),
#             event_type="RequirementDeduplicationStarted",
#         )

#         effective_correlation_id = tracking_token[
#             "correlation_id"
#         ]
...
#             "inputRequirementCount": requirement_count,
#         }

#         # Agent/enterprise logging does not receive the API bearer token.
...
#         try:
#             # Keep the request bearer token here. The graph passes it only to
#             # TokenUsageService after the LLM response is received.
...
#             result = extract_deduplication_result(
#                 final_state
#             )

#             completed_payload = {
#                 **common_payload,
#                 "canonicalRequirementCount": result.get(
...
#                     ),
#                 ),
#                 "duplicateRequirementCount": result.get(
#                     "DuplicateRequirementCount",
#                     0,
#                 ),
#                 "deduplicationStatus": result.get(
#                     "DeduplicationStatus"
#                 ),
#             }
...
#                 is_success=True,
#                 message=(
#                     "Requirement deduplication completed"
#                 ),
#                 event_type=(
...
#                 tracking_token=tracking_token,
#                 is_success=False,
#                 message="Requirement deduplication failed",
#                 event_type="RequirementDeduplicationFailed",
...
# DeduplicationAgent = RequirementDeduplicationAgent
