...
# # The bearer token is optional for running the agent.
# # When supplied through the API header, it is forwarded
# # only to token-usage logging.
...
# ) -> str | None:
#     """
#     Return only the raw bearer token.
