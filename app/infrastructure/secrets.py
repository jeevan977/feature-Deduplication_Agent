...
# # Usage 
# # 1. Import the class using from app.infrastructure.secrets import SecretManager
# # Create Object of the class
# secret_manager = SecretManager()

# try:
#     openai_api_key = secret_manager.get_secret() # call the get_secret() function

#     # print(type(openai_api_key))
#     # Avoid printing the actual API key.
