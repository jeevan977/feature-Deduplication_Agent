...
def build_deduplication_prompt(
    ...
    All instructions, rules, examples and output requirements are
    loaded from Constitution.md and Specification.md.

    Python only prepares the compact runtime requirements JSON and
    appends it after both instruction files.
    """
    ...
    if not prompt:
        raise ValueError(
            "The final Requirement Deduplication prompt is empty."
        )
    ...
    print(
        "Deduplication prompt prepared:",
        {
            ...
            "constitutionIncluded": True,
            "specificationIncluded": True,
            "promptRulesStoredInPython": False,
            "oneGoLlmInvocation": True,
        },
    )
